...
const ToolSvg = () => (
  <svg  viewBox="0 0 1024 1024" fill="#bfbfbf" version="1.1" xmlns="http://www.w3.org/2000/svg"
...
const Tool = (props: props) => <Icon component={ToolSvg} className={props.className} />
export default Tool
